...
var METADATA = '../sample_support_metadata.json';
var sampleName = '';
...
function extractFromManifest(content) {
  ...
  var note="// showing only keys relevant to this sample\n"+
    "// to see the complete manifest, click on the 'manifest.json' link above\n";
...
function getFileContents(filename, callback) {
  ...
  xhr.onerror=function() {
    console.warn('invalid file in '+METADATA+': '+filename);
  };
  xhr.send();
}
